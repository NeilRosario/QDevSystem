<%@ Page Title="Company List" Language="C#" MasterPageFile="~/Portals/Admin Portal/IT Admin Portal/IT_Admin_Portal.Master" AutoEventWireup="true" CodeBehind="ViewCompaniesAdmin.aspx.cs" Inherits="QDevSystem.Portals.Admin_Portal.IT_Admin_Portal.BP.ViewCompaniesAdmin" %>
                                ...
                                <asp:ListView ID="lvComp" runat="server"
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <a href='CompanyDetailsAdmin.aspx?ID=<%#Eval("b_access_id")%>'
