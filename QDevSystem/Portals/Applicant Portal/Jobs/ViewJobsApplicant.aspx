<%@ Page Title="Job Posts" Language="C#" MasterPageFile="~/Portals/Applicant Portal/Applicant_Portal.Master" AutoEventWireup="true" CodeBehind="ViewJobsApplicant.aspx.cs" Inherits="QDevSystem.Portals.Applicant_Portal.Jobs.ViewJobsApplicant" %>
                                ...
                                <asp:ListView ID="lvJobs" runat="server"
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <a href='JobDetailsApplicant.aspx?ID=<%#Eval("job_id")%>'
