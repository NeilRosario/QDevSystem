<%@ Page Title="Job Details" Language="C#" MasterPageFile="~/Portals/Applicant Portal/Applicant_Portal.Master" AutoEventWireup="true" CodeBehind="JobDetailsApplicant.aspx.cs" Inherits="QDevSystem.Portals.Applicant_Portal.Jobs.JobDetailsApplicant" %>
    ...
    <div class="box-body">
        <div class="form-horizontal">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="~/Portals/Applicant Portal/Jobs/ViewJobsApplicant.aspx" runat="server">Job List</a></li>
        ...
        <div class="jumbotron">
            ...
            <div class="col-lg-12">
                <asp:Button ID="btnApply" runat="server"
                    ...
                    Text="Send Application"></asp:Button>
